<?php
//File how contains code to create the tables as functions, these functins can be called in the main file
function createTeam(){
...
function createReferee(){
    ...
    $createTabelleReferee = "
        CREATE TABLE IF NOT EXISTS referee(
            ...
            player INT NOT NULL,
            assistent INT NOT NULL,
            PRIMARY KEY(id_referee),
            FOREIGN KEY (player) REFERENCES player(id_player),
            FOREIGN KEY (assistent) REFERENCES player(id_player)
    );";
